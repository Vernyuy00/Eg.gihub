...
map.getView().fit([355897.514346, 34813.061056, 2818222.282543, 1380775.529578], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">REGIONS DU CAMEROUN</h2>';
        return titleElement;
    })(),
